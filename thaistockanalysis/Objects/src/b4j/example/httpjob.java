...
public b4j.example.calculate _calculate = null;
...
__c.LogImpl("92621445",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("92097164",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("92359304","Cannot send files from the assets folder.",0);
